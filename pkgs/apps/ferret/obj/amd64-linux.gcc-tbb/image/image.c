...
int image_read_rgb_hsv (const char *filename, int *width, int *height, unsigned char **data_rgb, unsigned char **data_hsv)
{
  ...
  orig = (unsigned char *)malloc(cinfo.output_width * cinfo.output_height * 4);
  // fprintf(stderr, "quantize_colors: %d\n", cinfo.quantize_colors);
  // fprintf(stderr, "output_components: %d\n", cinfo.output_components);
  // fprintf(stderr, "out_color_components: %d\n", cinfo.out_color_components);
  // fprintf(stderr, "jpeg_color_space: %d\n", cinfo.jpeg_color_space);
